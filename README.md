...
- storage/app/public/fotos (as fotos que os usuários enviaram no chamados)
...
- Criar o .env (ver o .env.example na base do projeto)
    ...
    - Setar SUPER_ADM_USER e SUPER_ADM_PASS (será o superuser para manutenção/acesso god mode)
