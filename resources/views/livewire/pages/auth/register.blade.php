...
<div>
    <form wire:submit="register">
        ...
        <div class="mt-4" x-data>
            ...
            <x-text-input wire:model="cpf" id="cpf" class="block mt-1 w-full" type="text" name="cpf" required autofocus
                autocomplete="cpf" x-mask="999.999.999-99" placeholder="999.999.999-99" />
        </div>

        <!-- ALFABETIZADO -->
        <div class="mt-4 text-center">
            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                <input type="radio" class="btn-check" name="analfabeto" id="btnradio1" wire:model="analfabeto" value="0"
                    autocomplete="off">
                <label class="btn btn-outline-primary" for="btnradio1">Alfabetizado</label>
                <input type="radio" class="btn-check" name="analfabeto" id="btnradio2" wire:model="analfabeto" value="1"
                    autocomplete="off">
        ...
        <div class="flex items-center justify-center mt-4">
            <div class="block">
                <div><a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
