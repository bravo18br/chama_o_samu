...
<head>
    ...
    <meta name="userData" content="{{ json_encode(auth()->user()) }}">
...
<body class="font-sans antialiased">
    ...
    <!-- <script type="module" src="{{ asset('/storage/js/service-worker.js') }}"></script> -->
    <script type="module" src="{{ asset('/storage/js/app.js') }}"></script>
